...
const uint32_t CRYPTONOTE_MAX_BLOCK_NUMBER                   = 5000000000000;
const size_t   CRYPTONOTE_MAX_BLOCK_BLOB_SIZE                = 5000000000000;
const size_t   CRYPTONOTE_MAX_TX_SIZE                        = 100000000000000;
